package com.flex.dbmanager.ADAMap;
...
public class DBMap {
	...
	private static String DB_CATEGORY_NAME = "Postgre Configuration";
    ...
    static {
        try {
           ...
           try{
        	   configReader = Resources.getResourceAsReader("com/flex/resource/ADAMapConfig.xml");
	...
	private static Properties initProperties(){
		try{
			...
			String driver =IniFile.readConfigFileString(dbConfigPath,
					DB_CATEGORY_NAME, "driver", "org.postgresql.Driver", String.class);
			
			String url =IniFile.readConfigFileString(dbConfigPath,
					DB_CATEGORY_NAME, "url", "jdbc:postgresql://210.86.239.174:5432/maps", String.class);
