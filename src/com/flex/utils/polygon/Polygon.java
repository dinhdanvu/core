package com.flex.utils.polygon;
...
public class Polygon
{
	...
	/***
	 * Hàm tìm điểm giao giữa đoạn thẳng và đa giác
	 * thompt add ngày 04/12/2017
	 * @param poly : Đa giác
	 * @param line: Đoạn thẳng
	 * @return: True nếu có giao, false nếu không giao
	 * @throws Exception
	 */
	public boolean getIntersections(Polygon newPoly, Line line) {
		
		List<Line> _side = newPoly._sides;
		boolean intersection = false;
		for(int i=0; i< _side.size(); i++){
			boolean inter = Lib.getIntersection(_side.get(i), line);
